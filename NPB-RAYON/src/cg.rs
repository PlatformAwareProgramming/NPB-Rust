...
fn conj_grad(
    ...
    for _ in 1..cgitmax {
        ...
        (
            ...
            &mut q[0..(LASTCOL - FIRSTCOL + 1) as usize],
        )
            .into_par_iter()
            .for_each(|(j, j1, q)| {
         ...
         */
        d = (
            &p[0..(LASTCOL - FIRSTCOL + 1) as usize],
            &q[0..(LASTCOL - FIRSTCOL + 1) as usize],
        )
            .into_par_iter()
            .map(|(p, q)| *p * *q)
            .sum();
         ...
         */
        rho = (
            &mut z[0..(LASTCOL - FIRSTCOL + 1) as usize],
            &mut r[0..(LASTCOL - FIRSTCOL + 1) as usize],
            &p[0..(LASTCOL - FIRSTCOL + 1) as usize],
            &q[0..(LASTCOL - FIRSTCOL + 1) as usize],
        )
            .into_par_iter()
         ...
         */
        (
            &mut p[0..(LASTCOL - FIRSTCOL + 1) as usize],
            &r[0..(LASTCOL - FIRSTCOL + 1) as usize],
        )
            .into_par_iter()
            .for_each(|(p, r)| {
                *p = *r + beta * *p;
